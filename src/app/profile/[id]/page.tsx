          ...
          <div className="card h-fit p-6 sm:p-8">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                <h1 className="flex flex-wrap items-center gap-2 font-display text-3xl font-bold text-maroon">
                  <span className="truncate">{displayName}</span>
                  {profile.verified && (
                    <span className="inline-flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-0.5 text-xs font-semibold text-emerald-800" title="Verified Profile">
