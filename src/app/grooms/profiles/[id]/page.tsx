...
export default function GroomProfilePage() {
  ...
  const profile: GroomProfile = {
    ...
    partnerEducation: 'MBA or above',
    partnerOccupation: 'Business Owner',
    about: 'I am a business owner looking for a life partner who shares our cultural values. Family is central to my life and I respect tradition.',
    preferences: 'Looking for a compatible match within the Mali community, aged 25-32, from a respectful family background.',
    ...
    <section className="bg-cream">
      <div className="container-page py-24">
        <div className="mx-auto max-w-3xl">
          <h1 className="font-display text-3xl font-bold text-maroon mb-6">{t('pages.grooms.title')}: {profile.name}</h1>
